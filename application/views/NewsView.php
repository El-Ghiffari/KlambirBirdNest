...
<html>
<head>
    <title> News | KlambirBirdNest </title>
   ...
   <center><img src="<?php echo base_url(); ?>assets/images/News.png" class="img-fluid" alt="Responsive image"></center>
    ...
    <div class="row justify-content-center mb-4">
      <div class="col-md-10 text-center">
        <h1 data-aos="fade-up" class="mb-3"> Latest News (on Progress) </h1>
      </div>
    </div>
          ...
          <div class="col-md-4 d-flex">
            <div class="blog-entry align-self-stretch">
              ...
              <div class="text mt-3">
                ...
                <h3 class="heading"><a href="<?php echo base_url('index.php/home/postpage') ?>" ><?= $row->title ?> </a></h3>
                <p> <?= $row->description ?> </p>
              </div>
            </div>
          </div>

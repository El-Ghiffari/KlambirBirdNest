<html>
<head>
    <title> Post | KlambirBirdNest </title>
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
   ...
   <center><img src="<?php echo base_url(); ?>assets/images/News.png" class="img-fluid" alt="Responsive image"></center>
    ...
    <div class="site-section">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <img src="<?php echo base_url(); ?>assets/images/news1.png" alt="Image" class="img-fluid rounded">
          </div>
          <div class="col-md-5 ml-auto">
            <h2 class="text-primary mb-3">News #1</h2>
            <p class="lead">Hayooo..Ada yang dari Kebumen?</p>

            <p class="mb-4">
              <strong>
                .
                Ternyata oh ternyata guys...setelah mimin baca-baca.... Menurut buku "Pedoman Budidaya Walet" yang di terbitkan oleh dinas kehutanan dan perkebunan kabupaten Blitar. Sarang burung Walet Indonesia Pertama kali di temukan di Kebumen, Jawa Tengah Lohhhh..
                .
                .
                Nah udah pada tau belum? boleh di tag guys, teman kalian yang dari kebumen mimin pengem tau hihihi

                #pertanian #Petani #sarangburungwalet #presiden #resesi #ekonomi #resesiekonomi #berita #HUTRI #pemerintahanindonesia #pemerintah #burungwalet #pengusaha #Indonesia #burung #jualan #harikemerdekaanin #instagram #viral #independencedayindonesia #indonesia #wonderfulindonesia #Kbirdnest.id #BirdNest.id #Kebumen #JawaTengah
                </strong>
                <br>
            </p>
            <br>
            <p style="text-align: left;"><strong>KlamBirBirdNest.id TEAM</strong></p>
          </div>
        </div>
      </div>
    </div>

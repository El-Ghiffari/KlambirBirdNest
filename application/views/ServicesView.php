...
<html>
<head>
    <title> Services | KlambirBirdNest </title>
...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav m-auto">
            ...
            <li class="nav-item active"><a href="<?php echo base_url('index.php/home/service') ?>" class="nav-link">Services</a></li>
   ...
   <center><img src="<?php echo base_url(); ?>assets/images/Services.png" class="img-fluid" alt="Responsive image"></center>
    ...
    <div class="site-section">
      <h2 style="text-align: center;">Layanan dan Jasa</h2>
      <h4 style="text-align: center">#TumbuhBersamaUntukMendunia</h4>
      <br>
      <br>
      <div class="container">
        <div class="row" style="text-align: center">
            <br>
            <div class="col-sm-3">
              <i style="color : #1ba118" class="fa fa-cogs fa-5x"></i>
              <h4>BirdNest.id</h4>
              <p>Budi Daya dan Produksi</p>
            </div>
            <div class="col-sm-3">
              <i style="color : #1ba118" class="fa fa-handshake-o fa-5x"></i>
              <h4>BirdNest Market</h4>
              <p>Rantai Pasok Sarang Burung Walet (SBW)</p>
            </div>
            <div class="col-sm-3">
              <i style="color : #1ba118" class="fa fa-usd fa-5x"></i>
              <h4>BirdNest Fund</h4>
              <p>Pendanaan Bisnis SBW</p>
            </div>
            <div class="col-sm-3">
              <i style="color : #1ba118" class="fa fa-globe fa-5x"></i>
              <h4>BirdNest Today</h4>
              <p>Berita seputar SBW</p>
            </div>
          </div>
          <br><br>
          <div class="row" style="text-align: center">
            <div class="col-sm-3">
              <i style="color : #1ba118" class="fa fa-fire fa-5x"></i>
              <h4>BirdNest Cook</h4>
              <p>Tips Memasak SBW</p>
            </div>
            <div class="col-sm-3">
              <i style="color : #1ba118" class="fa fa-user fa-5x"></i>
              <h4>BirdNest Story</h4>
              <p>Cerita Pelaku Bisnis SBW</p>
            </div>
            <div class="col-sm-3">
              <i style="color : #1ba118" class="fa fa-graduation-cap fa-5x"></i>
              <h4 style="color:#303030;">BirdNest Institute</h4>
              <p>Sekolah SBW</p>
            </div>
            <div class="col-sm-3">
              <i style="color : #1ba118" class="fa fa-link fa-5x"></i>
              <h4 style="color:#303030;">BirdNest Connect</h4>
              <p>Mitra dan Cabang</p>
            </div>
          </div>
        </div>
      </div>
